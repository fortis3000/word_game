...
const TRANSLATIONS = {
    'en': {
        ...
        howToPlayRule4: "<strong>Use Shuffle <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' style='width: 1.2em; height: 1.2em; vertical-align: -0.2em; color: var(--text-muted);'><polyline points='16 3 21 3 21 8' /><line x1='4' x2='21' y1='20' y2='3' /><polyline points='21 16 21 21 16 21' /><line x1='15' x2='21' y1='15' y2='21' /><line x1='4' x2='9' y1='4' y2='9' /></svg>:</strong> Stuck? Use the Shuffle button to rearrange the words and spot new associations.",
        howToPlayRule5: "<strong>Help <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' style='width: 1.2em; height: 1.2em; vertical-align: -0.2em; color: var(--text-muted);'><circle cx='12' cy='12' r='10' /><path d='M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3' /><line x1='12' x2='12.01' y1='17' y2='17' /></svg>:</strong> Tap the Help button to review these rules again at any time during the game.",
    ...
    'de': {
        ...
        howToPlayRule4: "<strong>Mischen <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' style='width: 1.2em; height: 1.2em; vertical-align: -0.2em; color: var(--text-muted);'><polyline points='16 3 21 3 21 8' /><line x1='4' x2='21' y1='20' y2='3' /><polyline points='21 16 21 21 16 21' /><line x1='15' x2='21' y1='15' y2='21' /><line x1='4' x2='9' y1='4' y2='9' /></svg> benutzen:</strong> Kommst du nicht weiter? Nutze die Mischen-Taste, um die Wörter neu anzuordnen und neue Assoziationen zu entdecken.",
        howToPlayRule5: "<strong>Hilfe <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' style='width: 1.2em; height: 1.2em; vertical-align: -0.2em; color: var(--text-muted);'><circle cx='12' cy='12' r='10' /><path d='M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3' /><line x1='12' x2='12.01' y1='17' y2='17' /></svg>:</strong> Tippe auf die Hilfe-Taste, um diese Regeln jederzeit während des Spiels erneut zu lesen.",
    ...
    'ru': {
        ...
        howToPlayRule4: "<strong>Перемешивание <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' style='width: 1.2em; height: 1.2em; vertical-align: -0.2em; color: var(--text-muted);'><polyline points='16 3 21 3 21 8' /><line x1='4' x2='21' y1='20' y2='3' /><polyline points='21 16 21 21 16 21' /><line x1='15' x2='21' y1='15' y2='21' /><line x1='4' x2='9' y1='4' y2='9' /></svg>:</strong> Застряли? Используйте кнопку перемешивания, чтобы взглянуть на слова под другим углом и найти новые связи.",
        howToPlayRule5: "<strong>Помощь <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' style='width: 1.2em; height: 1.2em; vertical-align: -0.2em; color: var(--text-muted);'><circle cx='12' cy='12' r='10' /><path d='M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3' /><line x1='12' x2='12.01' y1='17' y2='17' /></svg>:</strong> Нажмите на кнопку Помощь, чтобы просмотреть эти правила в любое время во время игры.",
